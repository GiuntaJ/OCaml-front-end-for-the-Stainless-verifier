...
object benchmarks_crazy2add_sub193 {
    ...
    case (c1, c2) =>
      {
        (c1, c2) match {
          case (NIL, c2) => { c2 }
          case (c1, NIL) => { c1 }
          case (ZERO(c11), ZERO(c22)) => { ZERO(crazy2add(c11, c22)) }
          case (ZERO(c11), ONE(c22)) => { ONE(crazy2add(c11, c22)) }
          case (ZERO(c11), MONE(c22)) => { MONE(crazy2add(c11, c22)) }
          case (ONE(c11), ZERO(c22)) => { ONE(crazy2add(c11, c22)) }
          case (ONE(c11), ONE(c22)) => {
            ZERO(crazy2add(ONE(NIL), crazy2add(c11, c22)))
          }
          case (ONE(c11), MONE(c22)) => { ZERO(crazy2add(c11, c22)) }
          case (MONE(c11), ZERO(c22)) => { MONE(crazy2add(c11, c22)) }
          case (MONE(c11), ONE(c22)) => { ZERO(crazy2add(c11, c22)) }
          case (MONE(c11), MONE(c22)) => {
            ZERO(crazy2add(MONE(NIL), crazy2add(c11, c22)))
          }
        }
    }
  }
